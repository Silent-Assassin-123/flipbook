const SUPABASE_URL = 'https://apilcpxiutexjcepnurc.supabase.co';
const SUPABASE_ANON_KEY = 'sb_publishable_cnC0sQKWPOm0wZH9Zl4z6A_8n9BvGH9';
...
fileInput.addEventListener('change', async (event) => {
    ...
    if (uploadError) {
        alert('Storage error occurred during file transfer.');
